...
- 🐈 [CatSVG](https://catsvg.vercel.app) — Cat-based image placeholder service. Every URL is a deterministic SVG cat — no image files, no storage, ~2.9 × 10¹⁴ combinations. [(GitHub)](https://github.com/TimMikeladze/catsvg)
